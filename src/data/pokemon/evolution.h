const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                       ...
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ESPEON},
                                       {EVO_ITEM, ITEM_DAWN_STONE, SPECIES_UMBREON},
                                    #if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_AZURILL]               = {{EVO_LEVEL, 13, SPECIES_MARILL}},
    ...
    [SPECIES_BUDEW]                 = {{EVO_LEVEL, 14, SPECIES_ROSELIA}},
    ...
    [SPECIES_CHINGLING]             = {{EVO_LEVEL, 16, SPECIES_CHIMECHO}},
    ...
    [SPECIES_MUNCHLAX]              = {{EVO_LEVEL, 25, SPECIES_SNORLAX}},
    [SPECIES_RIOLU]                 = {{EVO_LEVEL, 25, SPECIES_LUCARIO}},
    ...
    [SPECIES_WOOBAT]                = {{EVO_LEVEL, 20, SPECIES_SWOOBAT}},
    ...
    [SPECIES_SWADLOON]              = {{EVO_LEVEL, 25, SPECIES_LEAVANNY}},
    ...
    [SPECIES_TYPE_NULL]             = {{EVO_LEVEL, 30, SPECIES_SILVALLY}},
    ...
    [SPECIES_SNOM]                  = {{EVO_LEVEL, 25, SPECIES_FROSMOTH}},
