...
static const struct TrainerMon sParty_GruntPetalburgWoods[] = {
     {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    .species = SPECIES_KOFFING,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_POISON_GAS, MOVE_ASSURANCE, MOVE_SECRET_POWER}
    },
      {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPING_HAND, MOVE_SWEET_KISS, MOVE_DRAINING_KISS, MOVE_LOVELY_KISS}
    },
      {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    .species = SPECIES_POOCHYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_QUICK_ATTACK, MOVE_SCREECH, MOVE_ASTONISH}
    },
      {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 12,
    ...
    .moves = {MOVE_ARM_THRUST, MOVE_COMET_PUNCH, MOVE_ATTRACT, MOVE_LEER}
    }
};
...
static const struct TrainerMon sParty_Matt[] = {
    {
    .ivs = TRAINER_PARTY_IVS(6, 6, 6, 6, 6, 6),
    .lvl = 34,
...
static const struct TrainerMon sParty_Archie[] = {
    {
    .ivs = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 41,
    .species = SPECIES_MIGHTYENA,
    },
    {
...
static const struct TrainerMon sParty_Rose2[] = {
    {
    .ivs = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 26,
    .species = SPECIES_SHROOMISH,
    },
    {
...
static const struct TrainerMon sParty_Rose3[] = {
    {
    .ivs = TRAINER_PARTY_IVS(2, 2, 2, 2, 2, 2),
    .lvl = 28,
    .species = SPECIES_SHROOMISH,
    },
    {
...
static const struct TrainerMon sParty_Rose4[] = {
    {
    .ivs = TRAINER_PARTY_IVS(3, 3, 3, 3, 3, 3),
    .lvl = 31,
    .species = SPECIES_SHROOMISH,
    },
    {
...
static const struct TrainerMon sParty_Rose5[] = {
    {
    .ivs = TRAINER_PARTY_IVS(4, 4, 4, 4, 4, 4),
    .lvl = 34,
...
static const struct TrainerMon sParty_Dusty2[] = {
    {
    .ivs = TRAINER_PARTY_IVS(7, 7, 7, 7, 7, 7),
    .lvl = 27,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    }
...
static const struct TrainerMon sParty_Dusty3[] = {
    {
    .ivs = TRAINER_PARTY_IVS(8, 8, 8, 8, 8, 8),
    .lvl = 30,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    }
...
static const struct TrainerMon sParty_Dusty4[] = {
    {
    .ivs = TRAINER_PARTY_IVS(9, 9, 9, 9, 9, 9),
    .lvl = 33,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    }
...
static const struct TrainerMon sParty_Dusty5[] = {
    {
    .ivs = TRAINER_PARTY_IVS(10, 10, 10, 10, 10, 10),
    .lvl = 36,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_SLASH, MOVE_SAND_ATTACK, MOVE_POISON_STING}
    }
...
static const struct TrainerMon sParty_GabbyAndTy4[] = {
    {
    .ivs = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 33,
    .species = SPECIES_MAGNETON,
    },
    {
...
static const struct TrainerMon sParty_GabbyAndTy5[] = {
    {
    .ivs = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 36,
    .species = SPECIES_MAGNETON,
    },
    {
...
static const struct TrainerMon sParty_Wilton2[] = {
    {
    .ivs = TRAINER_PARTY_IVS(13, 13, 13, 13, 13, 13),
    .lvl = 26,
    .species = SPECIES_ELECTRIKE,
    },
    {
...
static const struct TrainerMon sParty_Wilton3[] = {
    {
    .ivs = TRAINER_PARTY_IVS(14, 14, 14, 14, 14, 14),
    .lvl = 29,
    .species = SPECIES_MANECTRIC,
    },
    {
...
static const struct TrainerMon sParty_Wilton4[] = {
    {
    .ivs = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 32,
    .species = SPECIES_MANECTRIC,
    },
    {
...
static const struct TrainerMon sParty_Wilton5[] = {
    {
    .ivs = TRAINER_PARTY_IVS(17, 17, 17, 17, 17, 17),
    .lvl = 35,
    .species = SPECIES_MANECTRIC,
    },
    {
...
static const struct TrainerMon sParty_Cindy1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BONE_CLUB, MOVE_HEADBUTT, MOVE_ROCK_THROW, MOVE_PROTECT}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRAINING_KISS, MOVE_MAGICAL_LEAF, MOVE_HELPING_HAND, MOVE_LEECH_SEED}
    }
};
...
static const struct TrainerMon sParty_Winston1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FURY_SWIPES, MOVE_PAY_DAY, MOVE_FAKE_OUT, MOVE_BITE}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 11,
    .species = SPECIES_SKITTY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ASSIST, MOVE_SECRET_POWER, MOVE_DISARMING_VOICE, MOVE_SING}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 11,
    ...
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_TAIL_SLAP, MOVE_SING, MOVE_WAKE_UP_SLAP, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    {
    .ivs = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 14,
    .species = SPECIES_ARCHEN,
    .heldItem = ITEM_NONE,
    .ability = ABILITY_SLOT_1,
    .moves = {MOVE_ROCK_TOMB, MOVE_ROCK_SLIDE, MOVE_PLUCK, MOVE_U_TURN}
    },
    {
    .ivs = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_RECOVER, MOVE_WATER_GUN, MOVE_ICY_WIND, MOVE_EXPLOSION}
    },
    {
    .ivs = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 15,
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_FIRE_SPIN, MOVE_ROCK_TOMB, MOVE_RAPID_SPIN}
    },
       {
    .ivs = TRAINER_PARTY_IVS(16, 16, 16, 16, 16, 16),
    .lvl = 16,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_SLIDE, MOVE_ROCK_SMASH, MOVE_THUNDER_PUNCH, MOVE_HEADBUTT}
    },
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    {
    .ivs = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 22,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
...
static const struct TrainerMon sParty_Winona1[] = {
    {
    .ivs = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 29,
...
static const struct TrainerMon sParty_Timothy4[] = {
    {
    .ivs = TRAINER_PARTY_IVS(27, 27, 27, 27, 27, 27),
    .lvl = 39,
    .species = SPECIES_HARIYAMA,
...
static const struct TrainerMon sParty_Timothy5[] = {
    {
    .ivs = TRAINER_PARTY_IVS(29, 29, 29, 29, 29, 29),
    .lvl = 42,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_ARM_THRUST, MOVE_BELLY_DRUM, MOVE_SAND_ATTACK, MOVE_DIG}
    }
...
static const struct TrainerMon sParty_Calvin1[] = {
    ...
    .species = SPECIES_POOCHYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_PURSUIT, MOVE_QUICK_ATTACK, MOVE_LEER}
    }
};
...
static const struct TrainerMon sParty_Billy[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SECRET_POWER, MOVE_QUICK_ATTACK, MOVE_TAIL_WHIP}
    }
};
...
static const struct TrainerMon sParty_Josh[] = {
  ...
  .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LOW_KICK, MOVE_FURY_SWIPES, MOVE_ROCK_THROW, MOVE_COUNTER}
    },
    {
   .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 8,
    .species = SPECIES_TAILLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GUST, MOVE_DOUBLE_TEAM, MOVE_FLY, MOVE_QUICK_ATTACK}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 8,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_CURSE, MOVE_SWIFT, MOVE_AGILITY}
    }
};
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .moves = {MOVE_LICK, MOVE_COVET, MOVE_PIN_MISSILE, MOVE_LEER}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 6,
    .species = SPECIES_YUNGOOS,
    .moves = {MOVE_ATTRACT, MOVE_BITE, MOVE_BIDE, MOVE_RETURN}
    }
};
...
static const struct TrainerMon sParty_Donny[] = {
    ...
    {
    .ivs = TRAINER_PARTY_IVS(19, 19, 19, 19, 19, 19),
    .lvl = 34,
    .species = SPECIES_STARYU,
    }
};
...
static const struct TrainerMon sParty_GinaAndMia1[] = {
    ...
    .species = SPECIES_PLUSLE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NUZZLE, MOVE_HELPING_HAND, MOVE_ROUND, MOVE_ENCORE}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 13,
    .species = SPECIES_MINUN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NUZZLE, MOVE_HELPING_HAND, MOVE_ROUND, MOVE_PLAY_NICE}
    }
};
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAIRY_WIND, MOVE_DISARMING_VOICE, MOVE_CHARM}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 6,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METRONOME, MOVE_SOFT_BOILED, MOVE_BABY_DOLL_EYES, MOVE_POUND}  
    }
};
...
static const struct TrainerMon sParty_Haley1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METRONOME, MOVE_SING, MOVE_CHARM, MOVE_SOFT_BOILED}
    },
    {
    .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 11,
    .species = SPECIES_TOGEPI,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METRONOME, MOVE_SOFT_BOILED, MOVE_BABY_DOLL_EYES,}
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PIN_MISSILE, MOVE_STOMP, MOVE_QUICK_ATTACK, MOVE_GROWL}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 7,
...
static const struct TrainerMon sParty_Lyle[] = {
  {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSION, MOVE_SUPERSONIC, MOVE_DISABLE, MOVE_STRUGGLE_BUG}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_POWDER, MOVE_FURY_CUTTER, MOVE_LEECH_LIFE, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMon sParty_James1[] = {
    ...
    .species = SPECIES_NINCADA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_SLAP, MOVE_REST, MOVE_SNORE, MOVE_LEECH_LIFE}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 11,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTROWEB, MOVE_THUNDER_WAVE, MOVE_DOUBLE_TEAM, MOVE_ABSORB}
    }
};
...
static const struct TrainerMon sParty_Darian[] = {
   ...
   .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    ...
    .species = SPECIES_MAGIKARP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DIVE, MOVE_FLAIL, MOVE_PROTECT}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 8,
    .species = SPECIES_FEEBAS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAIL, MOVE_WATER_GUN, MOVE_BOUNCE}
    },
    {
        .ivs = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 9,
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AURORA_BEAM, MOVE_WATER_PULSE, MOVE_ATTRACT, MOVE_DIVE}
    }
};
